...
class NoticiaController
{
    ...
    public function activar($id){
        ...
        if ($noticia->activen == 1){
            ...
            ($consulta > 0) ? //Compruebo consulta para ver que no ha habido errores
                $this->view->redireccionConMensaje("admin/noticias","green","La noticia <strong>$noticia->title</strong> se ha desactivado correctamente.") :
            ...
            //Mensaje y redirección
            ($consulta > 0) ? //Compruebo consulta para ver que no ha habido errores
                $this->view->redireccionConMensaje("admin/noticias","green","La noticia <strong>$noticia->title</strong> se ha activado correctamente.") :
                $this->view->redireccionConMensaje("admin/noticias","red","Hubo un error al guardar en la base de datos.");
        }
    ...
    public function home($id){
        ...
        if ($noticia->home == 1){
            ...
            //Mensaje y redirección
            ($consulta > 0) ? //Compruebo consulta para ver que no ha habido errores
                $this->view->redireccionConMensaje("admin/noticias","green","La noticia <strong>$noticia->title</strong> ahora se muestra en la home.") :
                $this->view->redireccionConMensaje("admin/noticias","red","Hubo un error al guardar en la base de datos.");
        }
